...
public class CAdxTechnicalInfos implements java.io.Serializable {
	...
	public CAdxTechnicalInfos(boolean busy, boolean changeLanguage, boolean changeUserId, boolean flushAdx,
			double loadWebsDuration, int nbDistributionCycle, double poolDistribDuration, int poolEntryIdx,
			double poolExecDuration, double poolRequestDuration, double poolWaitDuration,
			java.lang.String processReport, int processReportSize, boolean reloadWebs, boolean resumitAfterDBOpen,
			int rowInDistribStack, double totalDuration, java.lang.String traceRequest, int traceRequestSize) {
		this.busy = busy;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = true && this.busy == other.isBusy() && this.changeLanguage == other.isChangeLanguage()
				&& this.changeUserId == other.isChangeUserId() && this.flushAdx == other.isFlushAdx()
				...
				&& this.poolEntryIdx == other.getPoolEntryIdx() && this.poolExecDuration == other.getPoolExecDuration()
				...
				&& ((this.processReport == null && other.getProcessReport() == null)
						|| (this.processReport != null && this.processReport.equals(other.getProcessReport())))
				&& this.processReportSize == other.getProcessReportSize() && this.reloadWebs == other.isReloadWebs()
				...
				&& ((this.traceRequest == null && other.getTraceRequest() == null)
						|| (this.traceRequest != null && this.traceRequest.equals(other.getTraceRequest())))
