...
public class CAdxResultXml  implements java.io.Serializable {
    private connexioWS.CAdxMessage[] messages;

    private java.lang.String resultXml;

    private int status;

    private connexioWS.CAdxTechnicalInfos technicalInfos;

    public CAdxResultXml() {
    }

    public CAdxResultXml(
    		connexioWS.CAdxMessage[] messages,
           java.lang.String resultXml,
           int status,
           connexioWS.CAdxTechnicalInfos technicalInfos) {
     ...
     * @return messages
     */
    public connexioWS.CAdxMessage[] getMessages() {
        return messages;
    }
     ...
     * @param messages
     */
    public void setMessages(connexioWS.CAdxMessage[] messages) {
        this.messages = messages;
    }
     ...
     */
    public connexioWS.CAdxTechnicalInfos getTechnicalInfos() {
        return technicalInfos;
    }
     ...
     */
    public void setTechnicalInfos(connexioWS.CAdxTechnicalInfos technicalInfos) {
        this.technicalInfos = technicalInfos;
    }
