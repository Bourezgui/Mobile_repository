...
<%
    ...
    if (e != null) {
        ...
        for (; e.hasMoreElements();) {
            ...
            out.write("<th style='border: .5px ${symbol_pound}A3BBFF solid;'>" + key + "</th>");
            out.write("<td style='border: .5px ${symbol_pound}A3BBFF solid;'>" + getFormatedSystemProperty(System.getProperty(key)) + "&nbsp;</td>");
            out.write("<tr>");
        }
        out.write("</table>");
        out.write("</pre><p>");
