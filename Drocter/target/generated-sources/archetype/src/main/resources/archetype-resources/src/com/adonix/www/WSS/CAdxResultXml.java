...
public class CAdxResultXml implements java.io.Serializable {
	...
	public CAdxResultXml(com.adonix.www.WSS.CAdxMessage[] messages, java.lang.String resultXml, int status,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof CAdxResultXml))
			return false;
		...
		_equals = true
				&& ((this.messages == null && other.getMessages() == null)
						|| (this.messages != null && java.util.Arrays.equals(this.messages, other.getMessages())))
				&& ((this.resultXml == null && other.getResultXml() == null)
						|| (this.resultXml != null && this.resultXml.equals(other.getResultXml())))
				&& this.status == other.getStatus()
				&& ((this.technicalInfos == null && other.getTechnicalInfos() == null)
						|| (this.technicalInfos != null && this.technicalInfos.equals(other.getTechnicalInfos())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		int _hashCode = 1;
		if (getMessages() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getMessages()); i++) {
